...
public interface IDataHelper {
    ...
    public  class NetConfig {
        ...
        /**
         *  can use multi baseurl {@link com.dhc.library.data.HttpHelper#createApi(Class,okhttp3.OkHttpClient)}
        ...
        /**
         * root baseurl {@link com.dhc.library.data.HttpHelper#createApi(Class,okhttp3.OkHttpClient)}
         * @param baseURL
         * @return
         */
