    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            if (contentView == null){
                ...
                contentView = inflater.inflate(R.layout.layout_common_toast, null);
                textView = (AppCompatTextView) contentView.findViewById(R.id.text_view);
            }

            sToast = new Toast(Utils.getContext());
//            sToast.setGravity(Gravity.CENTER_HORIZONTAL|Gravity.BOTTOM,0,80);
